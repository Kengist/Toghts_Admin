...
const SmallPublicCard = () => {
  ...
  return isOpen ? (
    <div className="chat-parent-container">
      {/* <p onClick={() => setIsOpen(false)}>Bakck</p> */}
            ...
            <div className="d-flex">
              ...
              >
                <div className="chat-details pt-2">
                  ...
                  <p className="chat-text mb-0 text-left">
                    I will like you to consider the posibility of
                  </p>
                </div>
              </div>
            </div>
...
export default SmallPublicCard;
